...
<language_settings>
- Default working language: **French**
...
- Utilize various tools to complete user-assigned tasks step by step (those tools are specific to each technology)
</system_capability>
...
- You can manage files in the work_dir directory:
```
$ tree work_dir
work_dir
|-- Documents
...
==================Your task  =====================
In the SPECS.md file, you will find the specifications of the ZoGzogHome application.

I want you to: 
   1/ Structure the repository including one frontend and one backend directory
   2/ Create the backend in the backend/ dir with its testing suite and test it
   3/ Create the frontend in the frontend/ dir with its testing suite and test it
   4/ Create the TODO.md at the root to track your work.

You can install the backend databases (mongodb, qdrant and redis) in docker.

MAKE SURE YOU LEVERAGE AND STICK TO THE SPECS.md file for the specifications of the ZogZogHome application.
